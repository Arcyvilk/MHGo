...
export const items: Item[] = [
  ...
  // QUEST
  {
    ...
    craftable: true,
    craftList: [
      { id: 'page1', type: ItemClass.ITEM, amount: 1 },
      { id: 'page2', type: ItemClass.ITEM, amount: 1 },
      { id: 'page3', type: ItemClass.ITEM, amount: 1 },
    ],
  },
  {
    ...
    craftable: true,
    craftList: [
      { id: 'scale5', type: ItemClass.MATERIAL, amount: 1 },
      { id: 'fin5', type: ItemClass.MATERIAL, amount: 1 },
      { id: 'claw5', type: ItemClass.MATERIAL, amount: 1 },
      { id: 'hide5', type: ItemClass.MATERIAL, amount: 1 },
    ],
  },
  {
  ...
  // WEAPON
  {
    ...
    craftable: true,
    craftList: [
      { id: 'claw1', type: ItemClass.MATERIAL, amount: 50 },
      { id: 'hide1', type: ItemClass.MATERIAL, amount: 10 },
    ],
  },
  // ARMOR
  {
    ...
    craftable: true,
    craftList: [
      { id: 'scale1', type: ItemClass.MATERIAL, amount: 10 },
      { id: 'scale2', type: ItemClass.MATERIAL, amount: 5 },
      { id: 'scale3', type: ItemClass.MATERIAL, amount: 2 },
      { id: 'scale4', type: ItemClass.MATERIAL, amount: 1 },
    ],
  },
];
